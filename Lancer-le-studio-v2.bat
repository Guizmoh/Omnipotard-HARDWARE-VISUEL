@echo off
REM Raccourci Windows : double-cliquer ce fichier lance le studio v2
REM (moins de reglages a l'ecran, ranges par onglets ; tout reste la).
cd /d "%~dp0"
title Studio Omnipotard v2
